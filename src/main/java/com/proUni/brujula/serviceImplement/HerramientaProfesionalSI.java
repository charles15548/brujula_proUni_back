...
import com.proUni.brujula.repository.HerramientasProfesionalRepository;
...
@Service
public class HerramientaProfesionalSI implements HerramientasService{

	@Autowired
	private HerramientasProfesionalRepository dao;
	...
	public ResponseEntity<Map<String, Object>> listarHerramientasProfesionalPorTipo(Long userId) {
		 Map<String, Object> respuesta = new HashMap<>();
	        List<HerramientasProfesional> herramienta = dao.findByDesarrolloProfesionalId(userId);
